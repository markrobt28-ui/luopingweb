          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer group">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/20 bg-white/5 text-blue-600 focus:ring-2 focus:ring-blue-500/20"
                />
                <span className="ml-2 text-gray-400 group-hover:text-white transition-colors">记住我</span>
              </label>
              <Link
                to="/forgot-password"
